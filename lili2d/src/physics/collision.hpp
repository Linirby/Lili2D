...
struct RaycastResult {
	...
	int hit_x, hit_y, hit_z; ///< The integer coordinates of the hit voxel/block.
	int adj_x, adj_y, adj_z; ///< The integer coordinates of the adjacent voxel/block (surface normal).
};

...
MainRenderPass::render(
    ...
    for (auto& pair : queue) {
        for (const DrawCommand& draw_cmd : pair.second) {
            ...
            uniforms.color[0] =
                draw_cmd.model.material->properties.color_tint.x;
            uniforms.color[1] =
                draw_cmd.model.material->properties.color_tint.y;
            uniforms.color[2] =
                draw_cmd.model.material->properties.color_tint.z;
            uniforms.color[3] =
                draw_cmd.model.material->properties.color_tint.w;
            uniforms.uv_bounds[0] =
                draw_cmd.model.material->properties.uv_bounds.x;
            uniforms.uv_bounds[1] =
                draw_cmd.model.material->properties.uv_bounds.y;
            uniforms.uv_bounds[2] =
                draw_cmd.model.material->properties.uv_bounds.z;
            uniforms.uv_bounds[3] =
                draw_cmd.model.material->properties.uv_bounds.w;
